 ...
 * Tijd: 30 minuten
 * Omschrijving:
 * Toon in de tabel in het berstand "lesopdracht_fom_data53.php" het label en de waarde
   van voornaam, tussenvoegsel(alleen wanneer deze in de naam zit) en achternaam wanneer deze zijn ingevuld op het formulier.
...
?>
<form method="get" action="lesopdracht_form_data53.php">
